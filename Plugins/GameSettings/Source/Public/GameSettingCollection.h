...
public:
	...
	virtual void GetSettingsForFilter(const FGameSettingFilterState& FilterState, TArray<TObjectPtr<UGameSetting>>& InOutSettings) const;
...
public:
	...
	virtual void GetSettingsForFilter(const FGameSettingFilterState& FilterState, TArray<TObjectPtr<UGameSetting>>& InOutSettings) const override;
