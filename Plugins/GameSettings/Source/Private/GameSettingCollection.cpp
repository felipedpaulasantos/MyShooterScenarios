...
void UGameSettingCollection::GetSettingsForFilter(const FGameSettingFilterState& FilterState, TArray<TObjectPtr<UGameSetting>>& InOutSettings) const
{
	for (UGameSetting* ChildSetting : Settings)
	{
		...
		{
			TArray<TObjectPtr<UGameSetting>> ChildSettings;
...
void UGameSettingCollectionPage::GetSettingsForFilter(const FGameSettingFilterState& FilterState, TArray<TObjectPtr<UGameSetting>>& InOutSettings) const
{
