...
void UGameSettingRegistry::GetSettingsForFilter(const FGameSettingFilterState& FilterState, TArray<TObjectPtr<UGameSetting>>& InOutSettings)
{
	TArray<TObjectPtr<UGameSetting>> RootSettings;
