...
void ULyraSettingsLocal::UpdateMobileFramePacing()
{
	...
	UE_LOG(LogConsoleResponse, Log, TEXT("Setting frame pace to %d Hz."), ActualLimitFPS);
	FPlatformRHIFramePacer::SetFramePace(ActualLimitFPS);

	ClampMobileQuality();

	UpdateDynamicResFrameTime((float)ActualLimitFPS);
}
